...
for i in range(1,20):
  ip=[] # https://www.imdb.com/title/tt0944947/reviews?ref_=tt_urv
 
  url = "https://www.imdb.com/title/tt0944947/reviews?ref_=tt_urv"+str(i)
  ...
  GOT_reviews=GOT_reviews+ip  # adding the reviews of one page to empty list which in future contains all the reviews
help(WordCloud)  
...
ip_rev_string = " ".join(GOT_reviews)
